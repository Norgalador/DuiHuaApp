...
import topicService from '../../services/ProfileService';
...
const Topic = ( props ) => {
    ...
    const [ newLanguagesSpoken, setLanguagesSpoken ] = useState("");
    const [ newLanguagesLearning, setLanguagesLearning ] = useState(false);
    const [ newInterests, setInterests ] = useState(false);
    const [ newDescription, setDescription ] = useState(false);
    const [ profileBeingDeleted, setProfileBeingDeleted ] = useState(null);
